    ...
    <div className="relative bg-[#fdf3e7]">
      ...
      <div className="relative z-10 text-center pt-80 pb-12">
        <div className="bg-[#fdf3e7] relative inline-block w-full">
          {/* Triangle Shape Full Width */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-full 
          w-0 h-0 border-l-[250px] border-r-[250px] border-b-[180px] 
        border-l-transparent border-r-transparent border-b-[#fdf3e7] "></div>
        ...
        <h2 className="text-5xl font-medium text-gray-900 whitespace-nowrap">
          ...
          <div className=" max-w-4xl mx-auto text-center flex justify-center mt-6 px-6">
            ...
            <p className="text-lg text-[#222222] max-w-lg  leading-relaxed">
              ...
              जो भारत की सनातन संस्कृति, परंपराओं और आध्यात्मिकता को 
      ...
      <div className="pb-16 max-w-5xl mx-auto text-center mt-12 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="relative z-10 w-full">
                <div className="bg-[#e5721b]/60 p-6 rounded-b-2xl mx-9 inline-block">
                <h3 className="text-5xl font-semibold text-white text-center mt-6">
                  हमारा मिशन
                </h3>
          ...
          >
            ...
            <div className="bg-orange-500/60 p-6 rounded-b-2xl mx-9 inline-block">
                <h3 className="text-5xl font-semibold text-white text-center mt-6">
                  हमारा विज़न
                </h3>
